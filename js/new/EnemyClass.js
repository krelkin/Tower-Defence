class Enemy extends Move{ //супостат

	constructor(id, type, index_point, current_position, end_point){}
		//PROPERTIES
		this.id = id;
		this.type = type;
	...
	move(game_field, delay, path, plus_speed = true){
